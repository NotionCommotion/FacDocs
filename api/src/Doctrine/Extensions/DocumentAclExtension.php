...
final class DocumentAclExtension implements QueryCollectionExtensionInterface   //, QueryItemExtensionInterface
{
    ...
    */
    ...
    {
        return is_a($resourceClass, DocumentInterface::class, true);
    }
}
