...
use App\Repository\Specification\CustomSpecificationResourceAclRepository;
...
#[ApiResource(
    uriTemplate: '/custom_specifications/{id}/resource_acl',
    uriVariables: ['id' => new Link(fromClass: CustomSpecification::class, fromProperty: 'resourceAcl')],
    operations: [
...
#[ORM\Entity(repositoryClass: CustomSpecificationResourceAclRepository::class)]
class CustomSpecificationResourceAcl extends AbstractResourceAcl
{
    ...
    #[SerializedName('customSpecification')]
    protected ?CustomSpecification $resource = null;
}
