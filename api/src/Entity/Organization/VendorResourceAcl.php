...
use App\Repository\Organization\VendorResourceAclRepository;
...
#[ApiResource(
    uriTemplate: '/vendors/{id}/resource_acl',
    uriVariables: ['id' => new Link(fromClass: Vendor::class, fromProperty: 'resourceAcl')],
    operations: [
...
#[ORM\Entity(repositoryClass: VendorResourceAclRepository::class)]
class VendorResourceAcl extends AbstractResourceAcl
{
    ...
    protected ?Vendor $resource = null;
}
