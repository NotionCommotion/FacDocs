...
use App\Repository\Project\ProjectResourceAclRepository;
...
#[ApiResource(
    uriTemplate: '/projects/{id}/resource_acl',
    uriVariables: ['id' => new Link(fromClass: Project::class, fromProperty: 'resourceAcl')],
    operations: [
...
#[ORM\Entity(repositoryClass: ProjectResourceAclRepository::class)]
class ProjectResourceAcl extends AbstractResourceAcl
{
