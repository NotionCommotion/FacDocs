...
#[ORM\Entity(repositoryClass: DocumentTypeRepository::class, readOnly: true)]
class DocumentType implements HasStringIdentifierRankedListInterface
{
    ...
    public function __construct(
        ...
        private DocumentTypeRankedList $rankedList
    ){}
}
