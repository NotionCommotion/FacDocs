...
use App\Repository\User\VendorUserResourceAclRepository;
...
#[ApiResource(
    uriTemplate: '/vendor_users/{id}/resource_acl',
    uriVariables: ['id' => new Link(fromClass: VendorUser::class, fromProperty: 'resourceAcl')],
    operations: [
...
#[ORM\Entity(repositoryClass: VendorUserResourceAclRepository::class)]
class VendorUserResourceAcl extends AbstractResourceAcl
{
    ...
    protected ?VendorUser $resource = null;
}
