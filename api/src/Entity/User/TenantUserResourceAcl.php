...
use App\Repository\User\TenantUserResourceAclRepository;
...
#[ApiResource(
    uriTemplate: '/tenant_users/{id}/resource_acl',
    uriVariables: ['id' => new Link(fromClass: TenantUser::class, fromProperty: 'resourceAcl')],
    operations: [
...
#[ORM\Entity(repositoryClass: TenantUserResourceAclRepository::class)]
class TenantUserResourceAcl extends AbstractResourceAcl 
{
    ...
    protected ?TenantUser $resource = null;
}
