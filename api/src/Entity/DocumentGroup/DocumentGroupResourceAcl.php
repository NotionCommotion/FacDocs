...
use App\Repository\DocumentGroup\DocumentGroupResourceAclRepository;
...
#[ApiResource(
    uriTemplate: '/document_groups/{id}/resource_acl',
    uriVariables: ['id' => new Link(fromClass: DocumentGroup::class, fromProperty: 'resourceAcl')],
    operations: [
...
#[ORM\Entity(repositoryClass: DocumentGroupResourceAclRepository::class)]
class DocumentGroupResourceAcl extends AbstractResourceAcl
{
    ...
    protected ?DocumentGroup $resource = null;
}
