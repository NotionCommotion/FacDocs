...
use App\Repository\Archive\ArchiveResourceAclRepository;
...
#[ApiResource(
    uriTemplate: '/archives/{id}/resource_acl',
    uriVariables: ['id' => new Link(fromClass: Archive::class, fromProperty: 'resourceAcl')],
    operations: [
...
#[ORM\Entity(repositoryClass: ArchiveResourceAclRepository::class)]
class ArchiveResourceAcl extends AbstractResourceAcl
{
    ...
    protected ?Archive $resource = null;
}
