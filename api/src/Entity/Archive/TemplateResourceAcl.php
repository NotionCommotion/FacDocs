...
use App\Repository\Archive\TemplateResourceAclRepository;
...
#[ApiResource(
    uriTemplate: '/templates/{id}/resource_acl',
    uriVariables: ['id' => new Link(fromClass: Template::class, fromProperty: 'resourceAcl')],
    operations: [
...
#[ORM\Entity(repositoryClass: TemplateResourceAclRepository::class)]
class TemplateResourceAcl extends AbstractResourceAcl
{
    ...
    protected ?Template $resource = null;
}
